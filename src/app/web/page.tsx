    ...
    <>
      ...
      <div className="bg-neutral-900 text-neutral-100 min-h-screen py-20 px-4 sm:px-8 font-sans">
        ...
        >
          ...
          {/* Fix: Escaped unescaped single quote */}
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <Image src="/images/mockup-1.jpg" alt="Mockup of a multilingual e-commerce site" className="w-full h-auto object-cover" width={600} height={400} />
                <div className="p-6">
              ...
              >
                {/* Fix: Replaced <img> with <Image> for optimization */}
                <Image src="/images/mockup-2.jpg" alt="Mockup of a corporate website with different language versions" className="w-full h-auto object-cover" width={600} height={400} />
                <div className="p-6">
